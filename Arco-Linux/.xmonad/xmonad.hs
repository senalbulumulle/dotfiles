--	Senal's xmonad config
--
--
--
--
--
--	This is modified from ArcoLinux xmonad config
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -----------------------------------------------------------------
  --	This is where you open your favorite tools and applications
  --
  --
  -----------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
  -- SENAL'S MODIFICATION: Replace from mod shift d to mod d to make it easier
  --                       Later on, replace dmenu with rofi. 
  -----------------------------------------------------------------------------
