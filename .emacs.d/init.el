...
(custom-set-variables
 ...
 '(package-selected-packages
   '(powershell ## which-key use-package org-bullets org no-littering ivy-rich ivy-prescient hydra helpful general evil-visual-mark-mode evil-collection dracula-theme doom-themes doom-modeline counsel command-log-mode auto-package-update)))
(custom-set-faces
